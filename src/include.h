#ifndef objc_compat_include_h__
#define objc_compat_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "objc-compat-include.h" to keep the #include statements in the
...
#include "_objc-compat-include.h"
